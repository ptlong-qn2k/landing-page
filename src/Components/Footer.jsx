            ...
            <div className="px-[112px] py-[85px] flex flex-row justify-between items-center">
                <div>
                    <div className="grid grid-cols-[110px_400px] gap-y-8 mb-8 items-center">
                        <p className="text-xl text-[#2947A9] font-medium uppercase">Address:</p>
                        <p className="justify-center">6391 Elgin St. Celina, Delaware 10299</p>
                        <p className="text-xl text-[#2947A9] font-medium uppercase">Phone:</p>
                        <p className="">+84 1102 2703</p>
                        <p className="text-xl text-[#2947A9] font-medium uppercase">Email:</p>
                ...
                <div>
                    <h3 className="uppercase text-xl text-[#2947A9] font-medium mb-5">Newsletter:</h3>
                    <div className="flex flex-row items-center gap-2 mb-[42px]">
                        ...
                        />
                        <button className="w-[136px] h-[41px] bg-[#F9995D]">Subscribe</button>
                    </div>
                    <h3 className="uppercase text-xl text-[#2947A9] font-medium mb-5">Social:</h3>
